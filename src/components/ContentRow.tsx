...
export const ContentRow: React.FC<ContentRowProps> = ({
  ...
  return (
    <div className="px-4 md:px-8 mb-8">
      <h2 className="text-white text-xl md:text-2xl font-semibold mb-0">{title}</h2>
      ...
      <div className="relative group">
        ...
        <div
          ...
          className="flex space-x-4 overflow-x-auto overflow-y-visible scrollbar-hide scroll-smooth pt-4 pb-12"
